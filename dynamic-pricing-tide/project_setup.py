...
def main():
    ...
    azure_instrumentation_key = secret_client.get_secret("Instrumentation-Key").value
    print("Azure Application Insights Instrumentation Key retrieved successfully.")
